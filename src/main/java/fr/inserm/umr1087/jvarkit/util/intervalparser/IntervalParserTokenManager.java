/* Generated By:JavaCC: Do not edit this line. IntervalParserTokenManager.java */
...
/** Token Manager. */
public class IntervalParserTokenManager implements IntervalParserConstants
{
...
/** Constructor. */
public IntervalParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public IntervalParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
